...
<head>
    ...
    <link rel="stylesheet" href="css/reservaCanchaDeTenis.css">
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container-formulario">
        <form action="insertarreservacanchadetenis.php" method="POST" class="form">
            <div class="form">
                <h1 class="titulo-contactanos">RESERVA CANCHA DE TENIS</h1>
                <div class="grupo">
